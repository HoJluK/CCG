...
public class CardAbility : MonoBehaviour
{
    ...
    public GameObject Sheild, Provocation;
    ...
    public void OnDamageTake(CardControllerScr attacker = null)
    {
        ...
        foreach (var ability in CC.Card.Abilities)
        {
            switch (ability)
            {
                ...
                case Card.AbilityType.COUNTER_ATTACKER:
                    if (attacker != null)
                        attacker.Card.GetDamag(CC.Card.Attack);
                    break;
            }
        }
    }
